...
MODEL_PARAMETERS = {
    ...
    # Zhipu / GLM models
    "glm-4": {"temperature": 0.1, "top_p": 0.9},
    "glm-4-plus": {"temperature": 0.1, "top_p": 0.9},
    "glm-4-flash": {"temperature": 0.1, "top_p": 0.9},
    "glm-5.2": {"temperature": 0.1, "top_p": 0.9},
    # Groq models
    "llama3-70b-8192": {"temperature": 0.1, "top_p": 0.9},
    "llama3-8b-8192": {"temperature": 0.1, "top_p": 0.9},
...
MODEL_PROVIDER_MAPPING = {
    ...
    "glm-5.2": ModelProvider.ZHIPU,
    # Groq models
    "llama3-70b-8192": ModelProvider.GROQ,
    "llama3-8b-8192": ModelProvider.GROQ,
